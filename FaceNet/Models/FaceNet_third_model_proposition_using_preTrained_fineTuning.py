...
class Embed_model:
    ...
    def __new__(self,summary=False):
        model = load_model('A:\FaceNet Extension\AttendanceSystem\FaceNet\Facenet_TL_ep10',custom_objects={'triplet_loss': self.triplet_loss}) #specify path to folder having SavedModel File
